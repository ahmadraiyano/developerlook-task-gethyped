        ...
        <div>
            ...
            <div className='flex justify-between items-end'>
                ...
                <div className='w-5/12 text-2xl font-semibold'>
                    ...
                    <button className='btn btn-outline text-xl transition-transform duration-500 ease-in-out skew-0 hover:-skew-4'>Leer ons kennen <span className='bg-black text-white p-1 rounded-md'><FaArrowRight /></span></button>
                </div>
